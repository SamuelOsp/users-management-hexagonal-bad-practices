...
public final class ConsoleIO {
  ...
  private static final String VALUE_CANNOT_BE_BLANK = "  Value cannot be blank. Please try again.";
  private static final String INVALID_NUMBER_INPUT = "  Invalid input. Please enter a number.";
  ...
  public String readRequired(final String prompt) {
    ...
    do {
      ...
      if (value.isBlank()) {
        out.println(VALUE_CANNOT_BE_BLANK);
      }
    } while (value.isBlank());
    return value;
  }
  ...
  public int readInt(final String prompt) {
    while (true) {
      ...
      try {
        ...
        out.println(INVALID_NUMBER_INPUT);
      }
    }
  }
